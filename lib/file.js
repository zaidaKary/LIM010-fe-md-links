...
const verifyFile = route => fs.statSync(route).isFile(); // statSync() proporciona infor. sobre un archivo
...
const readFile = route => fs.readFileSync(route, 'utf8'); // devuelve el contenido de la ruta.
